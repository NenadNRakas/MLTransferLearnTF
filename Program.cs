...
namespace MLTransferLearnTF
{
    ...
    internal class Program
    {
        ...
        // Create the object paths with global variables
        static readonly string _assetsPath = Path.Combine(Environment.CurrentDirectory, "assets");
        static readonly string _imagesFolder = Path.Combine(_assetsPath, "images");
        static readonly string _trainTagsTsv = Path.Combine(_imagesFolder, "tags.tsv");
        static readonly string _testTagsTsv = Path.Combine(_imagesFolder, "test-tags.tsv");
        static readonly string _predictSingleImage = Path.Combine(_imagesFolder, "penguin.jpg");
        ...
        private static void Main(string[] args)
        {
            ...
            ITransformer model = Prog.GenerateModel(mlContext);
            Prog.ClassifySingleImage(mlContext, model);
            Console.ReadKey();
        }
        ...
        private ITransformer GenerateModel(MLContext mlContext)
        {
            IEstimator<ITransformer> pipeline = mlContext.Transforms.LoadImages(outputColumnName: "input", imageFolder: _imagesFolder, inputColumnName: nameof(ImageData.ImagePath))
                ...
                Console.WriteLine("");
                Console.WriteLine("-----------------------ML Model Training in Progress------------------------------");
                Console.WriteLine("");
                // Execute the traning
                ...
                Console.WriteLine("");
                Console.WriteLine("-----------------------ML Model Traning Metrics-----------------------------------");
                Console.WriteLine("");
                // Evaluate the data
                ...
                Console.WriteLine($"Overall-LogLoss is: {metrics.LogLoss}");
        ...
        public void ClassifySingleImage(MLContext mlContext, ITransformer model)
        {
            ...
            // Make a single prediction function (input = ImageData, output = ImagePrediction)
            ...
            Console.WriteLine("");
            Console.WriteLine("-----------------------ML Model Procedure Complete--------------------------------");
            Console.WriteLine("");
        }
